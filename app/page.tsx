  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center p-4 md:p-8 overflow-hidden">
      ...
      <main className="relative z-10 w-full max-w-4xl border border-green-500/30 bg-black/80 p-6 md:p-12 shadow-[0_0_15px_rgba(0,255,0,0.1)] mt-10 mb-20">
        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-4 pt-8">
            ...
            <button
              ...
              className="px-6 py-2 border border-gray-700 text-gray-400 hover:border-white hover:text-white transition-all duration-300 font-bold"
            >
              {t.btnContact}
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="border border-green-500/20 bg-black/50 p-5 hover:border-green-500 hover:shadow-[0_0_15px_rgba(0,255,0,0.15)] transition-all group">
              ...
              <ul className="text-sm text-gray-400 space-y-2">
                ...
                <li><span className="text-green-500">├──</span> Kubernetes</li>
                <li><span className="text-green-500">├──</span> Terraform / Ansible</li>
                <li><span className="text-green-500">└──</span> Docker</li>
              </ul>
            </div>
            <div className="border border-green-500/20 bg-black/50 p-5 hover:border-green-500 hover:shadow-[0_0_15px_rgba(0,255,0,0.15)] transition-all group">
		...
		{/* PASSIONS / PROFILE */}
        <div className="mt-20 border-t border-green-500/30 pt-8">
          <p className="text-sm md:text-base text-green-400/70 mb-6">
            [root@kub-andytropmimi ~]# cat ~/.bash_profile
          </p>

          <div className="border border-green-500/20 bg-black/50 p-6 hover:border-green-500/40 transition-all">
            <h3 className="text-white font-bold mb-4 font-mono">&gt; Personal Interests & Automation</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-400 font-mono">
              ...
              <div className="space-y-2 border-t border-gray-800 md:border-t-0 md:border-l md:border-gray-800 md:pl-6 pt-2 md:pt-0">
                <p className="text-gray-500 italic"># Custom scripts running in background:</p>
                <ul className="space-y-1 text-xs">
                  <li><span className="text-green-500">✔</span> anilist-updater.sh <span className="text-gray-600">(Auto-tracking anime list via API)</span></li>
                  <li><span className="text-green-500">✔</span> life-optimizer.py <span className="text-gray-600">(Automating everything in daily routine)</span></li>
                  <li><span className="text-green-500">✔</span> smart-home-trigger.sh <span className="text-gray-600">(Managing IoT & server metrics)</span></li>
                </ul>
              </div>
            </div>
          </div>
		...
		{/* CONTACT */}
        <div id="contact" className="mt-20 border-t border-green-500/30 pt-8 scroll-mt-12">
          <p className="text-sm md:text-base text-green-400/70 mb-6">
            [root@kub-andytropmimi ~]# ./ping_andy.sh
          </p>

          <div className="flex flex-col md:flex-row gap-6 items-center justify-center bg-black/50 border border-green-500/20 p-8 hover:border-green-500/50 transition-colors">

            {/* Lien LinkedIn */}
            <a href="https://www.linkedin.com/in/andy-malgonne/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-400 hover:text-green-500 transition-colors group text-lg font-bold">
            ...
            {/* Lien GitHub */}
            <a href="https://github.com/andymalgonne" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-400 hover:text-green-500 transition-colors group text-lg font-bold">
              <svg className="w-6 h-6 text-green-500 group-hover:animate-pulse drop-shadow-[0_0_5px_rgba(34,197,94,0.8)]" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Lien Email */}
            <a href="mailto:contact@andytropmimi.fr" className="flex items-center gap-3 text-gray-400 hover:text-green-500 transition-colors group text-lg font-bold">
              <svg className="w-6 h-6 text-green-500 group-hover:animate-pulse drop-shadow-[0_0_5px_rgba(34,197,94,0.8)]" fill="currentColor" viewBox="0 0 24 24">
